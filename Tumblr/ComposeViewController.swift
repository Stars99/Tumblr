...
class ComposeViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        UIView.animate(withDuration: 00.5, delay: 0.4, usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: [], animations: {
        ...
        UIView.animate(withDuration: 00.5, delay: 0.2, usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: [], animations: {
            self.chatButton.center.y = 155
            }, completion: nil)
        
        
        
        UIView.animate(withDuration: 0.5, delay: 0.2, usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: [], animations: {
